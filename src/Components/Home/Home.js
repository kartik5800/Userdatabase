...
const histroy = useHistory();
  ...
  const [postsPerPage, setpostsPerPage] = useState(userData.length);
      ...
      <div className="container">
        ...
        <div className="tab-content" id="nav-tabContent">
          <ul className="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">InActive</button>
            </li>
          </ul>
          <div className="tab-content" id="myTabContent">
            <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
              ...
              <div className='fw-bold'>
                Showing home 1 to {postsPerPage} of {userData.length}
              </div>
              <div className="page">
                <Pagination
          ...
          <div className="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex="0"><ActiveUser /></div>
          <div className="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex="0"><InActiveUser /></div>
        </div>
        <div>
      </div>
